function Boat(game, x, y) {
  ...
  this.hitCircles.push(
    new hitCircle(
      this.game,
      this.x - 25 * Math.cos(this.angle * Math.PI / 180),
      this.y - 25 * Math.sin(this.angle * Math.PI / 180)
    )
  );
  this.hitCircles.push(
    new hitCircle(
...
Boat.prototype.createCannons = function(number) {
  var j = 0;
  var k = 0;
...
Boat.prototype.shoot = function(side) {
...
Boat.prototype.move = function() {
  ...
  this.hitCircles[1].move(
    this.x - 10 * Math.cos(this.angle * Math.PI / 180),
    this.y - 10 * Math.sin(this.angle * Math.PI / 180)
  );
  this.hitCircles[2].move(
    this.x - 20 * Math.cos(this.angle * Math.PI / 180),
    this.y - 20 * Math.sin(this.angle * Math.PI / 180)
  );
  this.hitCircles[3].move(
    this.x - 25 * Math.cos(this.angle * Math.PI / 180),
    this.y - 25 * Math.sin(this.angle * Math.PI / 180)
  );
  this.hitCircles[4].move(
    this.x + 10 * Math.cos(this.angle * Math.PI / 180),
    this.y + 10 * Math.sin(this.angle * Math.PI / 180)
  );
  this.hitCircles[5].move(
    this.x + 20 * Math.cos(this.angle * Math.PI / 180),
    this.y + 20 * Math.sin(this.angle * Math.PI / 180)
  );
  this.hitCircles[6].move(
    this.x + 25 * Math.cos(this.angle * Math.PI / 180),
    this.y + 25 * Math.sin(this.angle * Math.PI / 180)
  );
};
